      ...
      <section className="relative pt-32 pb-20 px-4 min-h-[90vh] flex items-center">
        ...
        <div className="container mx-auto max-w-6xl relative z-10">
          <div className="text-center mb-12 animate-fade-in">
            <h1 className="font-orbitron text-5xl md:text-7xl font-bold mb-6 bg-gradient-to-r from-[#E59534] via-[#A86130] to-[#814B29] bg-clip-text text-transparent leading-tight drop-shadow-lg">
              Ваш личный эксперт в путешествиях
            </h1>
            <p className="text-xl md:text-2xl text-[#74492D] mb-8 max-w-3xl mx-auto leading-relaxed drop-shadow-sm">
